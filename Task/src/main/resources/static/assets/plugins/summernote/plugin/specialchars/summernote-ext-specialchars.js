  ...
  $.extend($.summernote.plugins, {
    'specialchars': function(context) {
      ...
      var specialCharDataSet = [
 		 ...
 		 '&brvbar;', '&sect;', '&uml;', '&copy;', '&ordf;', '&laquo;', '&not;', '&reg;', '&macr;', 
 		 ...
 		 '&ucirc;', '&uuml;', '&yacute;', '&thorn;', '&yuml;', '&oelig;', '&scaron;',
 		 '&Yuml;', '&fnof;', '&circ;', '&tilde;', 
 		 '&alpha;', '&beta;', '&gamma;', '&delta;', '&epsilon;', '&zeta;', '&eta;', '&theta;', '&iota;', '&kappa;',
 		 '&lambda;', '&mu;', '&nu;', '&xi;', '&omicron;', '&pi;', '&rho;', '&sigmaf;', '&sigma;', '&tau;', '&upsilon;',
 		 '&phi;', '&chi;', '&psi;', '&omega;', '&thetasym;', '&upsih;', '&piv;', '&ndash;', '&mdash;', '&horbar;', 
 		 '&lsquo;', '&rsquo;', '&sbquo;', '&ldquo;', '&rdquo;', '&bdquo;', '&dagger;', '&bull;', '&hellip;', '&permil;', '&prime;',
 		 '&lsaquo;', '&rsaquo;', '&oline;', '&frasl;', '&euro;', '&image;', '&weierp;', '&real;', '&trade;', '&alefsym;', '&larr;', 
 		 '&uarr;', '&rarr;', '&darr;', '&harr;', '&crarr;', '&lArr;', '&uArr;', '&rArr;', '&dArr;', '&hArr;', '&forall;', '&part;',
 		 '&exist;', '&empty;', '&nabla;', '&isin;', '&notin;', '&ni;', '&prod;', '&sum;', '&minus;', '&lowast;', '&radic;', '&prop;', 
